...
> **Frozen old system.** This folder is a snapshot of commit `dccb09c`
> (`final predictions for round 25`, 23 Aug 2026). It is the pre-recalibration
> agent. The current system lives in the parent repo (`../agent/`). Do not
> overwrite that tree with this one. How to run both:
