...
### API Integration (The Hand-off)

The XGBoost model and SHAP explainer operate behind a FastAPI endpoint. When the LLM Orchestrator requires a mathematical baseline, it queries this tool and receives a heavily contextualized JSON payload:
